...
public sealed class ControllerOptions
{
    ...
    /// <summary>
    /// Field delimiter for parsing fault lines (default: pipe character).
    /// </summary>
    public char FieldDelimiter { get; set; } = '|';

    /// <summary>
    /// Expected number of fields in each fault line (timestamp, fault code, description).
    /// </summary>
    public int ExpectedFieldCount { get; set; } = 3;

    /// <summary>
    /// Whether to continue processing if a fault line fails to parse.
    /// </summary>
